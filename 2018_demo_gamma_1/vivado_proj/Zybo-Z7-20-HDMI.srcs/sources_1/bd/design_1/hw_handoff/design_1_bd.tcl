...
proc create_root_design { parentCell } {
  ...
  # Create instance: hls_contrast_stretch_0, and set properties
  set hls_contrast_stretch_0 [ create_bd_cell -type ip -vlnv digilentinc.com:IP:hls_contrast_stretch:1.0 hls_contrast_stretch_0 ]

  # Create instance: hls_gamma_correction_0, and set properties
  set hls_gamma_correction_0 [ create_bd_cell -type ip -vlnv digilentinc.com:IP:hls_gamma_correction:1.0 hls_gamma_correction_0 ]

  # Create instance: hls_saturation_enhan_0, and set properties
  set hls_saturation_enhan_0 [ create_bd_cell -type ip -vlnv digilentinc.com:IP:hls_saturation_enhance:1.0 hls_saturation_enhan_0 ]
  ...
  connect_bd_intf_net -intf_net axi_clock_converter_0_M_AXI [get_bd_intf_pins axi_clock_converter_0/M_AXI] [get_bd_intf_pins hls_gamma_correction_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net axi_clock_converter_1_M_AXI [get_bd_intf_pins axi_clock_converter_1/M_AXI] [get_bd_intf_pins hls_saturation_enhan_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net axi_clock_converter_2_M_AXI [get_bd_intf_pins axi_clock_converter_2/M_AXI] [get_bd_intf_pins hls_contrast_stretch_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_in_M_AXIS [get_bd_intf_pins axis_subset_converter_in/M_AXIS] [get_bd_intf_pins hls_gamma_correction_0/stream_in]
  ...
  connect_bd_intf_net -intf_net hls_contrast_stretch_0_stream_out [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins hls_contrast_stretch_0/stream_out]
  connect_bd_intf_net -intf_net hls_gamma_correction_0_stream_out [get_bd_intf_pins hls_gamma_correction_0/stream_out] [get_bd_intf_pins hls_saturation_enhan_0/stream_in]
  connect_bd_intf_net -intf_net hls_saturation_enhan_0_stream_out [get_bd_intf_pins hls_contrast_stretch_0/stream_in] [get_bd_intf_pins hls_saturation_enhan_0/stream_out]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_GP0_M04_AXI [get_bd_intf_pins axi_dynclk_0/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph_GP0/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_GP0_M05_AXI [get_bd_intf_pins axi_clock_converter_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph_GP0/M05_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_GP0_M06_AXI [get_bd_intf_pins axi_clock_converter_1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph_GP0/M06_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_GP0_M07_AXI [get_bd_intf_pins axi_clock_converter_2/S_AXI] [get_bd_intf_pins ps7_0_axi_periph_GP0/M07_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins axi_clock_converter_0/m_axi_aclk] [get_bd_pins axi_clock_converter_1/m_axi_aclk] [get_bd_pins axi_clock_converter_2/m_axi_aclk] [get_bd_pins axi_mem_intercon_HP0/ACLK] [get_bd_pins axi_mem_intercon_HP0/M00_ACLK] [get_bd_pins axi_mem_intercon_HP0/S00_ACLK] [get_bd_pins axi_mem_intercon_HP0/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_in/aclk] [get_bd_pins axis_subset_converter_out/aclk] [get_bd_pins hls_contrast_stretch_0/ap_clk] [get_bd_pins hls_gamma_correction_0/ap_clk] [get_bd_pins hls_saturation_enhan_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_133M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_clock_converter_0/s_axi_aresetn] [get_bd_pins axi_clock_converter_1/s_axi_aresetn] [get_bd_pins axi_clock_converter_2/s_axi_aresetn] [get_bd_pins axi_dynclk_0/s_axi_lite_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins dvi2rgb_1/aRst_n] [get_bd_pins ps7_0_axi_periph_GP0/M00_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M01_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M02_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M03_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M04_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M05_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M06_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/M07_ARESETN] [get_bd_pins ps7_0_axi_periph_GP0/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_in/s_axi_aresetn] [get_bd_pins v_tc_out/s_axi_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_clock_converter_0/m_axi_aresetn] [get_bd_pins axi_clock_converter_1/m_axi_aresetn] [get_bd_pins axi_clock_converter_2/m_axi_aresetn] [get_bd_pins axis_subset_converter_in/aresetn] [get_bd_pins axis_subset_converter_out/aresetn] [get_bd_pins hls_contrast_stretch_0/ap_rst_n] [get_bd_pins hls_gamma_correction_0/ap_rst_n] [get_bd_pins hls_saturation_enhan_0/ap_rst_n] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dynclk_0/S_AXI_LITE/S_AXI_LITE_reg] SEG_axi_dynclk_0_S_AXI_LITE_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hls_contrast_stretch_0/s_axi_AXILiteS/Reg] SEG_hls_contrast_stretch_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hls_gamma_correction_0/s_axi_AXILiteS/Reg] SEG_hls_gamma_correction_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hls_saturation_enhan_0/s_axi_AXILiteS/Reg] SEG_hls_saturation_enhan_0_Reg
