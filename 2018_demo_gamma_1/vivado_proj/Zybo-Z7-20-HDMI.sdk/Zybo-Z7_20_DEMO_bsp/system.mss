...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = hls_contrast_stretch
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = hls_contrast_stretch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = hls_gamma_correction
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = hls_gamma_correction_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = hls_saturation_enhance
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = hls_saturation_enhan_0
END
